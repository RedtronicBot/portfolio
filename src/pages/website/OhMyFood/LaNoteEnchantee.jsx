...
function LaNoteEnchantee({onSetPage}) {
    ...
    return (
        <div>
            ...
            <main> 
                <img src={la_note_enchantee} alt="laNoteEnchantee" className="page_restaurant__image"/>    
                <div className="menu_restaurant">
                    <article className="menu_restaurant__header">
                        <h2 className="menu_restaurant__titre">La note enchantée</h2>
                        ...
                        <div className="bloc_menu_bouton">
                                ...
                                <div className="menu_restaurant__bouton__block">
                                    <div className="menu_restaurant__bouton__plat">
                                        <div className="menu_restaurant__bouton__bloc_titre">
                                            <h3 className="menu_restaurant__bouton__titre">Ravioles de foie gras</h3>
                                        </div>
                            ...
                            <article className="menu_restaurant__bouton animation2">
                                <div className="menu_restaurant__bouton__block">
                                    <div className="menu_restaurant__bouton__plat">
                                        <div className="menu_restaurant__bouton__bloc_titre">
                                            <h3 className="menu_restaurant__bouton__titre">Caviar osciètre</h3>
                                        </div>
                                        <div className="menu_restaurant__bouton__paragraphe">
                            ...
                            <article className="menu_restaurant__bouton animation3">
                                <div className="menu_restaurant__bouton__block">
                                    <div className="menu_restaurant__bouton__plat">
                                        <div className="menu_restaurant__bouton__bloc_titre">
                                            <h3 className="menu_restaurant__bouton__titre">Homard et espuma de potiron</h3>
                                        </div>
                                        <div className="menu_restaurant__bouton__paragraphe">
                        ...
                        <div className="bloc_menu_bouton">
                            <article className="menu_restaurant__bouton animation1">
                                <div className="menu_restaurant__bouton__block">
                                    <div className="menu_restaurant__bouton__plat">
                                        <div className="menu_restaurant__bouton__bloc_titre">
                                            <h3 className="menu_restaurant__bouton__titre">Noix de coquilles Saint-Jacques</h3>
                                        </div>
                                        <div className="menu_restaurant__bouton__paragraphe">
                            ...
                            <article className="menu_restaurant__bouton animation2">
                                <div className="menu_restaurant__bouton__block">
                                    <div className="menu_restaurant__bouton__plat">
                                        <div className="menu_restaurant__bouton__bloc_titre">
                                            <h3 className="menu_restaurant__bouton__titre">Langoustine poêlée</h3>
                                        </div>
                                        <div className="menu_restaurant__bouton__paragraphe">
                            ...
                            <article className="menu_restaurant__bouton animation3">
                                <div className="menu_restaurant__bouton__block">
                                    <div className="menu_restaurant__bouton__plat">
                                        <div className="menu_restaurant__bouton__bloc_titre">
                                            <h3 className="menu_restaurant__bouton__titre">Mijoté de queue de boeuf</h3>
                                        </div>
                                        <div className="menu_restaurant__bouton__paragraphe">
                        ...
                        <div className="bloc_menu_bouton">
                            <article className="menu_restaurant__bouton animation1">
                                <div className="menu_restaurant__bouton__block">
                                    <div className="menu_restaurant__bouton__plat">
                                        <div className="menu_restaurant__bouton__bloc_titre">
                                            <h3 className="menu_restaurant__bouton__titre">Macaron noisette et chocolat</h3>
                                        </div>
                                        <div className="menu_restaurant__bouton__paragraphe">
                            ...
                            <article className="menu_restaurant__bouton animation2">
                                <div className="menu_restaurant__bouton__block">
                                    <div className="menu_restaurant__bouton__plat">
                                        <div className="menu_restaurant__bouton__bloc_titre">
                                            <h3 className="menu_restaurant__bouton__titre">Baba au rhum revisité</h3>
                                        </div>
                                        <div className="menu_restaurant__bouton__paragraphe">
                            ...
                            <article className="menu_restaurant__bouton animation3">
                                <div className="menu_restaurant__bouton__block">
                                    <div className="menu_restaurant__bouton__plat">
                                        <div className="menu_restaurant__bouton__bloc_titre">
                                            <h3 className="menu_restaurant__bouton__titre">Tarte au citron meringuée</h3>
                                        </div>
                                        <div className="menu_restaurant__bouton__paragraphe">
                                            <p>Déstructurée</p>
                                        </div>
                    ...
                    <a href="/ohmyfood" className="bouton"><p className="bouton__paragraphe">Commander</p></a>
                </div>
            </main>
