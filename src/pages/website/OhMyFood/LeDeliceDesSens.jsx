...
function LeDeliceDesSens({onSetPage}) {
    ...
    return (
        <div>
            ...
            <main> 
                <img src={le_delice_des_sens} alt="LeDeliceDesSens" className="page_restaurant__image"/>    
                <div className="menu_restaurant">
                    <article className="menu_restaurant__header">
                        <h2 className="menu_restaurant__titre">Le délice des sens</h2>
                        ...
                        <div className="bloc_menu_bouton">
                                ...
                                <div className="menu_restaurant__bouton__block">
                                    <div className="menu_restaurant__bouton__plat">
                                        <div className="menu_restaurant__bouton__bloc_titre">
                                            <h3 className="menu_restaurant__bouton__titre">Tartare de thon</h3>
                                        </div>
                            ...
                            <article className="menu_restaurant__bouton animation2">
                                <div className="menu_restaurant__bouton__block">
                                    <div className="menu_restaurant__bouton__plat">
                                        <div className="menu_restaurant__bouton__bloc_titre">
                                            <h3 className="menu_restaurant__bouton__titre">Bouchée de homard croustillant</h3>
                                        </div>
                                        <div className="menu_restaurant__bouton__paragraphe">
                            ...
                            <article className="menu_restaurant__bouton animation3">
                                <div className="menu_restaurant__bouton__block">
                                    <div className="menu_restaurant__bouton__plat">
                                        <div className="menu_restaurant__bouton__bloc_titre">
                                            <h3 className="menu_restaurant__bouton__titre">Velouté de cèpes</h3>
                                        </div>
                                        <div className="menu_restaurant__bouton__paragraphe">
                                            <p>Aux truffes</p>
                                        </div>
                        ...
                        <div className="bloc_menu_bouton">
                            <article className="menu_restaurant__bouton animation1">
                                <div className="menu_restaurant__bouton__block">
                                    <div className="menu_restaurant__bouton__plat">
                                        <div className="menu_restaurant__bouton__bloc_titre">
                                            <h3 className="menu_restaurant__bouton__titre">Poulet rôti aux herbes de Provence</h3>
                                        </div>
                                        <div className="menu_restaurant__bouton__paragraphe">
                            ...
                            <article className="menu_restaurant__bouton animation2">
                                <div className="menu_restaurant__bouton__block">
                                    <div className="menu_restaurant__bouton__plat">
                                        <div className="menu_restaurant__bouton__bloc_titre">
                                            <h3 className="menu_restaurant__bouton__titre">Langouste rôtie</h3>
                                        </div>
                                        <div className="menu_restaurant__bouton__paragraphe">
                            ...
                            <article className="menu_restaurant__bouton animation3">
                                <div className="menu_restaurant__bouton__block">
                                    <div className="menu_restaurant__bouton__plat">
                                        <div className="menu_restaurant__bouton__bloc_titre">
                                            <h3 className="menu_restaurant__bouton__titre">Côte de boeuf Angus</h3>
                                        </div>
                                        <div className="menu_restaurant__bouton__paragraphe">
                        ...
                        <div className="bloc_menu_bouton">
                            <article className="menu_restaurant__bouton animation1">
                                <div className="menu_restaurant__bouton__block">
                                    <div className="menu_restaurant__bouton__plat">
                                        <div className="menu_restaurant__bouton__bloc_titre">
                                            <h3 className="menu_restaurant__bouton__titre">Farandole de desserts</h3>
                                        </div>
                                        <div className="menu_restaurant__bouton__paragraphe">
                                            <p>Du chef</p>
                                        </div>
                            ...
                            <article className="menu_restaurant__bouton animation2">
                                <div className="menu_restaurant__bouton__block">
                                    <div className="menu_restaurant__bouton__plat">
                                        <div className="menu_restaurant__bouton__bloc_titre">
                                            <h3 className="menu_restaurant__bouton__titre">Crème brulée</h3>
                                        </div>
                                        <div className="menu_restaurant__bouton__paragraphe">
                                            <p>Revisitée</p>
                                        </div>
                            ...
                            <article className="menu_restaurant__bouton animation3">
                                <div className="menu_restaurant__bouton__block">
                                    <div className="menu_restaurant__bouton__plat">
                                        <div className="menu_restaurant__bouton__bloc_titre">
                                            <h3 className="menu_restaurant__bouton__titre">Tiramisu</h3>
                                        </div>
                                        <div className="menu_restaurant__bouton__paragraphe">
                                            <p>À la noisette</p>
                                        </div>
